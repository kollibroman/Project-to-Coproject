...
{
    /// <inheritdoc />
    public partial class InitialProjectsAndRbac : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationModuleEntityFeatureEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationModuleEntityFeatureEntity", x => new { x.FeaturesId, x.ModulesId });
                    table.ForeignKey(
                        name: "FK_ApplicationModuleEntityFeatureEntity_Features_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationModuleEntityFeatureEntity_Modules_ModulesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectCollaborators", x => new { x.AssignedProjectsId, x.CollaboratorsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectCollaborators_Projects_AssignedProjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationModuleEntityFeatureEntity_ModulesId",
                table: "ApplicationModuleEntityFeatureEntity",
                column: "ModulesId");
